...
public class SocietyActivity extends AppCompatActivity {
    ...
    private String category = "society";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create three random numbers in the range 0-26
        Random randomObj = new Random();
        final int finalRand1 = randomObj.nextInt(27);
        int rand2 = randomObj.nextInt(27);
        while(rand2 == finalRand1){
            rand2 = randomObj.nextInt(27);
        }
        int rand3 = randomObj.nextInt(27);
        while(rand3 == rand2 || rand3 == finalRand1){
            rand3 = randomObj.nextInt(27);
        }
        ...
        SocietyCard card1 = new SocietyCard(finalRand1);
        SocietyCard card2 = new SocietyCard(finalRand2);
        SocietyCard card3 = new SocietyCard(finalRand3);
        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mContinueButtonNotClickable){
                    Toast.makeText(SocietyActivity.this, "Please choose a " +
    ...
    public void setOnClickListeners(){
        mCard1AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                 mCard1AgreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                 mCard1DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                 card1Position = 1;
                 card1Clicked = true;
        ...
        mCard1DisagreeButton.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 mCard1AgreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                 mCard1DisagreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                 card1Position = 0;
                 card1Clicked = true;
                 if(card2Clicked && card3Clicked){
                     setmContinueButton();
        ...
        mCard2AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                card2Position = 1;
                card2Clicked = true;
        ...
        mCard2DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                card2Position = 0;
                card2Clicked = true;
                if(card1Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard3AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                card3Position = 1;
                card3Clicked = true;
        ...
        mCard3DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_unclicked_society);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_clicked_society);
                card3Position = 0;
                card3Clicked = true;
                if(card1Clicked && card2Clicked){
                    setmContinueButton();
