...
public class ReligionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int finalRand1 = randomObj.nextInt(19);
        int rand2 = randomObj.nextInt(19);
        while(rand2 == finalRand1){
            rand2 = randomObj.nextInt(19);
        }
        int rand3 = randomObj.nextInt(19);
        while(rand3 == rand2 || rand3 == finalRand1){
            rand3 = randomObj.nextInt(19);
        }
        ...
        ReligionCard card1 = new ReligionCard(finalRand1);
        ReligionCard card2 = new ReligionCard(finalRand2);
        ReligionCard card3 = new ReligionCard(finalRand3);
        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mContinueButtonNotClickable){
                    Toast.makeText(ReligionActivity.this, "Please choose a " +
                                    "position on each topic",
                            Toast.LENGTH_SHORT).show();
                }else{
                    saveData();
                    Intent intent = new Intent(ReligionActivity.this,
...
//        builder.append(getString(R.string.chooseTopicText2));
    ...
    public void setOnClickListeners(){
        mCard1AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                 mCard1AgreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                 mCard1DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                 card1Position = 1;
                 card1Clicked = true;
        ...
        mCard1DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard1AgreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                mCard1DisagreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                card1Position = 0;
                card1Clicked = true;
                if(card2Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard2AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                card2Position = 1;
                card2Clicked = true;
        ...
        mCard2DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                card2Position = 0;
                card2Clicked = true;
                if(card1Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard3AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                card3Position = 1;
                card3Clicked = true;
        ...
        mCard3DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_unclicked_religion);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_clicked_religion);
                card3Position = 0;
                card3Clicked = true;
                if(card1Clicked && card2Clicked){
                    setmContinueButton();
