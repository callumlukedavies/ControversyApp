...
public class MiscActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MiscCard card1 = new MiscCard(finalRand1);
        MiscCard card2 = new MiscCard(finalRand2);
        MiscCard card3 = new MiscCard(finalRand3);
        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mContinueButtonNotClickable){
                    Toast.makeText(MiscActivity.this, "Please choose a " +
                                    "position on each topic",
                            Toast.LENGTH_SHORT).show();
                }else{
                    saveData();
                    Intent intent = new Intent(MiscActivity.this,
...
//        builder.append(getString(R.string.chooseTopicText2));
    ...
    public void setOnClickListeners(){
        mCard1AgreeButton.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 mCard1AgreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                 mCard1DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                 card1Position = 1;
                 card1Clicked = true;
        ...
        mCard1DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard1AgreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                mCard1DisagreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                card1Position = 0;
                card1Clicked = true;
                if(card2Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard2AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                card2Position = 1;
                card2Clicked = true;
        ...
        mCard2DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                card2Position = 0;
                card2Clicked = true;
                if(card1Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard3AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                card3Position = 1;
                card3Clicked = true;
        ...
        mCard3DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_unclicked_misc);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_clicked_misc);
                card3Position = 0;
                card3Clicked = true;
                if(card1Clicked && card2Clicked){
                    setmContinueButton();
