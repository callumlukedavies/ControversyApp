...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int finalRand1 = randomObj.nextInt(10);
        ...
        HistoryCard card1 = new HistoryCard(finalRand1);
        HistoryCard card2 = new HistoryCard(finalRand2);
        HistoryCard card3 = new HistoryCard(finalRand3);
        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mContinueButtonNotClickable){
                    Toast.makeText(HistoryActivity.this, "Please choose a " +
...
//        builder.append(getString(R.string.chooseTopicText2));
    ...
    public void setOnClickListeners(){
        mCard1AgreeButton.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 mCard1AgreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                 mCard1DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                 card1Position = 1;
                 card1Clicked = true;
        ...
        mCard1DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard1AgreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                mCard1DisagreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                card1Position = 0;
                card1Clicked = true;
                if(card2Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard2AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                card2Position = 1;
                card2Clicked = true;
        ...
        mCard2DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard2AgreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                mCard2DisagreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                card2Position = 0;
                card2Clicked = true;
                if(card1Clicked && card3Clicked){
                    setmContinueButton();
        ...
        mCard3AgreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                card3Position = 1;
                card3Clicked = true;
        ...
        mCard3DisagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCard3AgreeButton.setBackgroundResource(R.drawable.button_unclicked_history);
                mCard3DisagreeButton.setBackgroundResource(R.drawable.button_clicked_history);
                card3Position = 0;
                card3Clicked = true;
                if(card1Clicked && card2Clicked){
                    setmContinueButton();
